...
class MaterialFragment : AbsPlayerFragment() {
    ...
    override fun onColorChanged(color: Int) {
        ...
        RetroColorUtil.colorizeToolbar(playerToolbar, ATHUtil.resolveColor(requireContext(), R.attr.iconColor), requireActivity())
    }
    ...
    private fun setUpPlayerToolbar() {
        playerToolbar.apply {
            ...
            RetroColorUtil.colorizeToolbar(this, ATHUtil.resolveColor(context, R.attr.iconColor), requireActivity())
        }
    }
